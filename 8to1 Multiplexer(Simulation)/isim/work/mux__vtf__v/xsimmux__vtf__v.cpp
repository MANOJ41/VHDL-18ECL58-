...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("mux_vtf_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("mux", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        topvl = new workMmux__vtf__v("mux_vtf_v");
