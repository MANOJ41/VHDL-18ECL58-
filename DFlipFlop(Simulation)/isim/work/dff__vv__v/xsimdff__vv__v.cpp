...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("dff_vv_v", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("dff", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF2);
        HSim__s5 * topvl = 0;
        topvl = new workMdff__vv__v("dff_vv_v");
